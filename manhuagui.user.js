...
//#region src/index.ts
	...
	async function createFullScreen() {
		...
		document.addEventListener("keypress", (e) => {
			if (document.activeElement && /textarea|input|select/i.test(document.activeElement.tagName)) return;
			if (e.key === "f") a.click();
		});
	}
