      ...
      window.addEventListener(
        ...
        throttle(() => {
          ...
          if (currentY < 50 || currentY + dom.clientHeight > dom.scrollHeight - 800 || diffY < -30) {
            (_a = this.fxiedDom) == null ? void 0 : _a.classList.remove("hide");
          } else {
            (_b = this.fxiedDom) == null ? void 0 : _b.classList.add("hide");
          }
          if (currentY > prevY) {
            storeY = currentY;
          }
